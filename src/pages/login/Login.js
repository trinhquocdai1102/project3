            ...
            <div className="Login-List">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div>
                                ...
                                <div key={index} className={item.className}>
                                    <label>
                                        ...
                                        <div className={item.classInputName}>
                                                <input name={item.name} type={item.type || showPassword} placeholder={item.placeholder}  {...register(item.name)} required onFocus={handleChangeOpacity} />
                        ...
                        <ul className="Forgot-Password">
                            ...
                            <li className="Form-ForgotPass"><Link to="/ForgotPassword">Forgot Password?</Link></li>
                        </ul>
                    </div>
                    <div className="DivForm">
                        <button className="BtnForm" type="submit" >Login</button>
                    </div>
                </form>
                <div className="FormWithOther">
                    ...
                    <ul>
                        ...
                        <li><a href="https://gmail.com/" target="_blank" rel="noopener noreferrer"><ion-icon name="logo-google"></ion-icon></a></li>
                        <li><a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoidmkifQ%3D%3D%22%7D" target="_blank" rel="noopener noreferrer"><ion-icon name="logo-twitter"></ion-icon></a></li>
                    </ul>
                </div>
